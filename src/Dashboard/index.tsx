        ...
        <div className="row vh-md-100">
          <div className="col-md-8 col-sm-10 col-12 mx-auto my-auto text-center">
            <h2
              ...
              style={{ color: "#1de9b6" }}
            >
              THC_NAZA NFT <br /> COLLECTION
            </h2>
            <p className="lead py-3">
              Introducing the Transhuman Coin "Neural Astronomy Zone Ancillary"
              NFTs.
              <br />
              <br />
              Embark on a journey into a metaverse of Transhumanism and
              tokenomics.
            </p>
            <br />
            <a href="https://bscscan.com/address/0xc14f351c2b83d9e1d63b3710e04bbd6b132ef5d9">
              View official THC NAZA Contract
            </a>
            <br />
            <br />
            <button
