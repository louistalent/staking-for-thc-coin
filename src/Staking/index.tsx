...
const Staking = () => {
  ...
  const changeStatus = (lockPeriod: number, apy: number) => {
    setStatusApp({
      ...statusApp,
      ido: { ...statusApp.ido, lockPeriod: lockPeriod, apy: apy },
    });
  };
  ...
  const getStakingInfo = async () => {
    try {
      ...
      if (Number(stakeDate.stakingDate) !== 0) {
        ...
        setStatusApp({
          ...statusApp,
          ido: { ...statusApp.ido, locked: false },
        });
      }
    } catch (error) {
      console.log(error);
      ...
      <div className="container">
        ...
        <div className="stake-panel">
          ...
          <div className="apy-btn">
            <button className="btn btn-primary btn-lg py-md-3 px-md-7 text-lg">
              {statusApp.ido.apy}% APY*
            </button>
          </div>
          <div className="ido-list">
            ...
            <div className="list-item">
              ...
              <span className="">on the {statusApp.ido.earlyUnstakeFee} %</span>
            </div>
            <div className="list-item">
          ...
          <div className={`panel-sm ${statusApp.ido.locked ? "" : "dis-ni"}`}>
            ...
            <div className="panel-btn">
              <button className="btn btn-primary" onClick={unstaking}>
                Unstake
              </button>
            </div>
          </div>
          ...
          >
            ...
            <button className={`btn btn-primary px-6`} onClick={Claim}>
              Claim
            </button>
          </div>
          <div>
          ...
          <div className="">
            <span className="">
              <span className="" style={{ color: "yellow", fontSize: "30px" }}>
                *
              </span>
              = 36% Early end staking fee is charged to all stakers who wish to
              withdraw their stake prior to 72 hours before the original end
              stake date.
            </span>
          </div>
          <div className="">
            ...
            >
              <a
                href="https://bscscan.com/address/0x144960C94c846D30C3b4f373C348ed5f13C1f42a"
                target={"_blank"}
              >
